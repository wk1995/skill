...
grep -Fq '"adapter_version": "1.0.0"' "$workbuddy_ai_output/.agent-build.json" || fail "WorkBuddy AI adapter version missing from build manifest"
grep -Fq '"artifact_version": "0.1.0"' "$workbuddy_ai_output/.agent-build.json" || fail "WorkBuddy AI artifact version missing from build manifest"
