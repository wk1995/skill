...
| `database-engineering` | Design, review, optimize, migrate, and troubleshoot PostgreSQL and MySQL databases using workload evidence and version-aware rollout plans. Use for schemas, SQL, indexes, slow queries, locking, connections, and database recovery planning; not for analytics-only queries or other database engines. | [README](skills/database-engineering/README.md) |
