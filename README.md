...
| `version-upgrade-policy` | Define, choose, validate, or apply a project's own release versions, including initial values, compatibility-based increments, custom formats, changelog evidence, and version-policy CI checks. Do not use for dependency/tool upgrades, ordinary code fixes, or build/publish execution alone. | [README](skills/version-upgrade-policy/README.md) |
<!-- skills-catalog:end -->
