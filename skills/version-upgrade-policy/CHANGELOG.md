...
- AGENTS.md integration: Added a scoped merge/update procedure and reusable self-contained rules for proactive assessment, pending release notes, one-time release finalization, unavailable-Skill fallback, and duplicate-free repeated application. Project-required assessments trigger even without a user bump request.
