...
| Skill | 用途 | 文档 |
| --- | --- | --- |
| `android-release-train` | `android-release-train` 用于编排受保护的 Android 交付路径：从功能或修复分支，经版本集成和发布提升，到签名 AAB、Google Play 发布及已验证的发布标签。 | [README](skills/android-release-train/README.zh-CN.md) |
