...
| `choose-project-doc-location` | `choose-project-doc-location` 根据内容和所属项目，为项目文档选择存放位置，包括 PRD、技术文档和机器可读的状态机规格文件。 | [README](skills/choose-project-doc-location/README.zh-CN.md) |
